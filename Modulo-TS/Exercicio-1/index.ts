...
function firstMenuOption(){
  const  
    name = prompt('Qual o nome da nave a ser registrada ?'),
    pilot = prompt('Qual o nome do piloto da nave ?'),
    crewLimit = Number(prompt('Quanto tripulantes a nave suporta ?')),
    confirmation = confirm(`Confirma o registro da nave ${name} com o piloto ${pilot} e o limite de tripulantes na nave é ${crewLimit} ?`)
...
function secondMenuOption(){
  const  
    name = prompt('Qual o nome do tripulante ?'),
    spaceshipName = prompt('Qual o nome da nave que ele será registrado ?'),
...
function thirdMenuOption(){
  const 
    spaceshipName = prompt('Qual o nome da nave a ser enviada ?'),
    spaceship = findSpaceship(spaceshipName);
